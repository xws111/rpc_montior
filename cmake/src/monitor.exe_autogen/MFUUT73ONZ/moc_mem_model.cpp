...
#include "../../../../include/qt/mem_model.h"
...
QT_MOC_LITERAL(6, 63, 12), // "QVector<int>"
QT_MOC_LITERAL(7, 76, 5) // "roles"

    },
    "monitor::MemModel\0dataChanged\0\0"
...
void monitor::MemModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (MemModel::*)(const QModelIndex & , const QModelIndex & , const QVector<int> & );
...
QT_INIT_METAOBJECT const QMetaObject monitor::MemModel::staticMetaObject = { {
    &MonitorModelBase::staticMetaObject,
    qt_meta_stringdata_monitor__MemModel.data,
    qt_meta_data_monitor__MemModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *monitor::MemModel::qt_metacast(const char *_clname)
{
    ...
    return MonitorModelBase::qt_metacast(_clname);
}

int monitor::MemModel::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = MonitorModelBase::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 1)
