...
static void InitDefaultsscc_info_MemInfo_mem_5finfo_2eproto() {
  ...
  {
    void* ptr = &::rpc_monitor::_MemInfo_default_instance_;
    new (ptr) ::rpc_monitor::MemInfo();
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_mem_5finfo_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::MemInfo, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::MemInfo, total_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::MemInfo, free_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::MemInfo, avail_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::MemInfo, buffers_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::MemInfo, cached_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::MemInfo, swap_cached_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::MemInfo, active_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::MemInfo, inactive_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::MemInfo, active_anon_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::MemInfo, inactive_anon_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::MemInfo, active_file_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::MemInfo, inactive_file_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::MemInfo, dirty_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::MemInfo, writeback_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::MemInfo, anon_pages_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::MemInfo, mapped_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::MemInfo, kreclaimable_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::MemInfo, sreclaimable_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::MemInfo, sunreclaim_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::MemInfo, used_percent_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::rpc_monitor::MemInfo)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::rpc_monitor::_MemInfo_default_instance_),
};

const char descriptor_table_protodef_mem_5finfo_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\016mem_info.proto\022\013rpc_monitor\"\201\003\n\007MemInf"
  ...
  "apped\030\020 \001(\002\022\024\n\014kReclaimable\030\021 \001(\002\022\024\n\014sRe"
  "claimable\030\022 \001(\002\022\022\n\nsUnreclaim\030\023 \001(\002\022\024\n\014u"
  "sed_percent\030\037 \001(\002b\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_mem_5finfo_2eproto = {
  false, false, descriptor_table_protodef_mem_5finfo_2eproto, "mem_info.proto", 425,
...
MemInfo::MemInfo(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:rpc_monitor.MemInfo)
}
MemInfo::MemInfo(const MemInfo& from)
  ...
  // @@protoc_insertion_point(copy_constructor:rpc_monitor.MemInfo)
}
...
MemInfo::~MemInfo() {
  // @@protoc_insertion_point(destructor:rpc_monitor.MemInfo)
  SharedDtor();
...
void MemInfo::Clear() {
// @@protoc_insertion_point(message_clear_start:rpc_monitor.MemInfo)
...
::PROTOBUF_NAMESPACE_ID::uint8* MemInfo::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:rpc_monitor.MemInfo)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:rpc_monitor.MemInfo)
  return target;
}

size_t MemInfo::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:rpc_monitor.MemInfo)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:rpc_monitor.MemInfo)
  GOOGLE_DCHECK_NE(&from, this);
  const MemInfo* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<MemInfo>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:rpc_monitor.MemInfo)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:rpc_monitor.MemInfo)
    MergeFrom(*source);
  }
}

void MemInfo::MergeFrom(const MemInfo& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:rpc_monitor.MemInfo)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:rpc_monitor.MemInfo)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:rpc_monitor.MemInfo)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::rpc_monitor::MemInfo* Arena::CreateMaybeMessage< ::rpc_monitor::MemInfo >(Arena* arena) {
  return Arena::CreateMessageInternal< ::rpc_monitor::MemInfo >(arena);
}
