...
PROTOBUF_NAMESPACE_OPEN
template<> ::rpc_monitor::CpuStat* Arena::CreateMaybeMessage<::rpc_monitor::CpuStat>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace rpc_monitor {
...
class CpuStat PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:rpc_monitor.CpuStat) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:rpc_monitor.CpuStat)
 private:
  class _Internal;
...
inline const std::string& CpuStat::cpu_name() const {
  // @@protoc_insertion_point(field_get:rpc_monitor.CpuStat.cpu_name)
  return _internal_cpu_name();
}
inline void CpuStat::set_cpu_name(const std::string& value) {
  _internal_set_cpu_name(value);
  // @@protoc_insertion_point(field_set:rpc_monitor.CpuStat.cpu_name)
}
inline std::string* CpuStat::mutable_cpu_name() {
  // @@protoc_insertion_point(field_mutable:rpc_monitor.CpuStat.cpu_name)
...
inline void CpuStat::set_cpu_name(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:rpc_monitor.CpuStat.cpu_name)
}
inline void CpuStat::set_cpu_name(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:rpc_monitor.CpuStat.cpu_name)
}
inline void CpuStat::set_cpu_name(const char* value,
    size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:rpc_monitor.CpuStat.cpu_name)
}
...
inline std::string* CpuStat::release_cpu_name() {
  // @@protoc_insertion_point(field_release:rpc_monitor.CpuStat.cpu_name)
...
inline void CpuStat::set_allocated_cpu_name(std::string* cpu_name) {
  ...
  cpu_name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), cpu_name,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:rpc_monitor.CpuStat.cpu_name)
}
...
inline float CpuStat::cpu_percent() const {
  // @@protoc_insertion_point(field_get:rpc_monitor.CpuStat.cpu_percent)
...
inline void CpuStat::set_cpu_percent(float value) {
  ...
  // @@protoc_insertion_point(field_set:rpc_monitor.CpuStat.cpu_percent)
}
...
inline float CpuStat::usr_percent() const {
  // @@protoc_insertion_point(field_get:rpc_monitor.CpuStat.usr_percent)
...
inline void CpuStat::set_usr_percent(float value) {
  ...
  // @@protoc_insertion_point(field_set:rpc_monitor.CpuStat.usr_percent)
}
...
inline float CpuStat::system_percent() const {
  // @@protoc_insertion_point(field_get:rpc_monitor.CpuStat.system_percent)
...
inline void CpuStat::set_system_percent(float value) {
  ...
  // @@protoc_insertion_point(field_set:rpc_monitor.CpuStat.system_percent)
}
...
inline float CpuStat::nice_percent() const {
  // @@protoc_insertion_point(field_get:rpc_monitor.CpuStat.nice_percent)
...
inline void CpuStat::set_nice_percent(float value) {
  ...
  // @@protoc_insertion_point(field_set:rpc_monitor.CpuStat.nice_percent)
}
...
inline float CpuStat::idle_percent() const {
  // @@protoc_insertion_point(field_get:rpc_monitor.CpuStat.idle_percent)
...
inline void CpuStat::set_idle_percent(float value) {
  ...
  // @@protoc_insertion_point(field_set:rpc_monitor.CpuStat.idle_percent)
}
...
inline float CpuStat::io_wait_percent() const {
  // @@protoc_insertion_point(field_get:rpc_monitor.CpuStat.io_wait_percent)
...
inline void CpuStat::set_io_wait_percent(float value) {
  ...
  // @@protoc_insertion_point(field_set:rpc_monitor.CpuStat.io_wait_percent)
}
...
inline float CpuStat::irq_percent() const {
  // @@protoc_insertion_point(field_get:rpc_monitor.CpuStat.irq_percent)
...
inline void CpuStat::set_irq_percent(float value) {
  ...
  // @@protoc_insertion_point(field_set:rpc_monitor.CpuStat.irq_percent)
}
...
inline float CpuStat::soft_irq_percent() const {
  // @@protoc_insertion_point(field_get:rpc_monitor.CpuStat.soft_irq_percent)
...
inline void CpuStat::set_soft_irq_percent(float value) {
  ...
  // @@protoc_insertion_point(field_set:rpc_monitor.CpuStat.soft_irq_percent)
}
