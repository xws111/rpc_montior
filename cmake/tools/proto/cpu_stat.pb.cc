...
static void InitDefaultsscc_info_CpuStat_cpu_5fstat_2eproto() {
  ...
  {
    void* ptr = &::rpc_monitor::_CpuStat_default_instance_;
    new (ptr) ::rpc_monitor::CpuStat();
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_cpu_5fstat_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::CpuStat, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::CpuStat, cpu_name_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::CpuStat, cpu_percent_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::CpuStat, usr_percent_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::CpuStat, system_percent_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::CpuStat, nice_percent_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::CpuStat, idle_percent_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::CpuStat, io_wait_percent_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::CpuStat, irq_percent_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::CpuStat, soft_irq_percent_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::rpc_monitor::CpuStat)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::rpc_monitor::_CpuStat_default_instance_),
};

const char descriptor_table_protodef_cpu_5fstat_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\016cpu_stat.proto\022\013rpc_monitor\"\321\001\n\007CpuSta"
  "t\022\020\n\010cpu_name\030\001 \001(\t\022\023\n\013cpu_percent\030\002 \001(\002"
  "\022\023\n\013usr_percent\030\003 \001(\002\022\026\n\016system_percent\030"
  "\004 \001(\002\022\024\n\014nice_percent\030\005 \001(\002\022\024\n\014idle_perc"
  "ent\030\006 \001(\002\022\027\n\017io_wait_percent\030\007 \001(\002\022\023\n\013ir"
  "q_percent\030\010 \001(\002\022\030\n\020soft_irq_percent\030\t \001("
  "\002b\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_cpu_5fstat_2eproto = {
  false, false, descriptor_table_protodef_cpu_5fstat_2eproto, "cpu_stat.proto", 249,
...
CpuStat::CpuStat(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:rpc_monitor.CpuStat)
}
CpuStat::CpuStat(const CpuStat& from)
  ...
  // @@protoc_insertion_point(copy_constructor:rpc_monitor.CpuStat)
}
...
CpuStat::~CpuStat() {
  // @@protoc_insertion_point(destructor:rpc_monitor.CpuStat)
  SharedDtor();
...
void CpuStat::Clear() {
// @@protoc_insertion_point(message_clear_start:rpc_monitor.CpuStat)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "rpc_monitor.CpuStat.cpu_name"));
          CHK_(ptr);
...
::PROTOBUF_NAMESPACE_ID::uint8* CpuStat::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:rpc_monitor.CpuStat)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:rpc_monitor.CpuStat)
  return target;
}

size_t CpuStat::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:rpc_monitor.CpuStat)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:rpc_monitor.CpuStat)
  GOOGLE_DCHECK_NE(&from, this);
  const CpuStat* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<CpuStat>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:rpc_monitor.CpuStat)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:rpc_monitor.CpuStat)
    MergeFrom(*source);
  }
}

void CpuStat::MergeFrom(const CpuStat& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:rpc_monitor.CpuStat)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:rpc_monitor.CpuStat)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:rpc_monitor.CpuStat)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::rpc_monitor::CpuStat* Arena::CreateMaybeMessage< ::rpc_monitor::CpuStat >(Arena* arena) {
  return Arena::CreateMessageInternal< ::rpc_monitor::CpuStat >(arena);
}
