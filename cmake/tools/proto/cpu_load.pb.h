...
PROTOBUF_NAMESPACE_OPEN
template<> ::rpc_monitor::CpuLoad* Arena::CreateMaybeMessage<::rpc_monitor::CpuLoad>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace rpc_monitor {
...
class CpuLoad PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:rpc_monitor.CpuLoad) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:rpc_monitor.CpuLoad)
 private:
  class _Internal;
...
inline float CpuLoad::load_avg_1() const {
  // @@protoc_insertion_point(field_get:rpc_monitor.CpuLoad.load_avg_1)
...
inline void CpuLoad::set_load_avg_1(float value) {
  ...
  // @@protoc_insertion_point(field_set:rpc_monitor.CpuLoad.load_avg_1)
}
...
inline float CpuLoad::load_avg_3() const {
  // @@protoc_insertion_point(field_get:rpc_monitor.CpuLoad.load_avg_3)
...
inline void CpuLoad::set_load_avg_3(float value) {
  ...
  // @@protoc_insertion_point(field_set:rpc_monitor.CpuLoad.load_avg_3)
}
...
inline float CpuLoad::load_avg_15() const {
  // @@protoc_insertion_point(field_get:rpc_monitor.CpuLoad.load_avg_15)
...
inline void CpuLoad::set_load_avg_15(float value) {
  ...
  // @@protoc_insertion_point(field_set:rpc_monitor.CpuLoad.load_avg_15)
}
