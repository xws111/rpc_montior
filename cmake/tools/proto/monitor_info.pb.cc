...
static void InitDefaultsscc_info_MonitorInfo_monitor_5finfo_2eproto() {
  ...
  {
    void* ptr = &::rpc_monitor::_MonitorInfo_default_instance_;
    new (ptr) ::rpc_monitor::MonitorInfo();
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_monitor_5finfo_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::MonitorInfo, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::MonitorInfo, name_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::MonitorInfo, soft_irq_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::MonitorInfo, cpu_load_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::MonitorInfo, cpu_stat_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::MonitorInfo, mem_info_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::MonitorInfo, net_info_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::rpc_monitor::MonitorInfo)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::rpc_monitor::_MonitorInfo_default_instance_),
};

const char descriptor_table_protodef_monitor_5finfo_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\022monitor_info.proto\022\013rpc_monitor\032\033googl"
  "e/protobuf/empty.proto\032\016cpu_load.proto\032\021"
  "cpu_softirq.proto\032\016cpu_stat.proto\032\016mem_i"
  "nfo.proto\032\016net_info.proto\"\343\001\n\013MonitorInf"
  "o\022\014\n\004name\030\001 \001(\t\022&\n\010soft_irq\030\004 \003(\0132\024.rpc_"
  "monitor.SoftIrq\022&\n\010cpu_load\030\005 \001(\0132\024.rpc_"
  "monitor.CpuLoad\022&\n\010cpu_stat\030\006 \003(\0132\024.rpc_"
  "monitor.CpuStat\022&\n\010mem_info\030\007 \001(\0132\024.rpc_"
  "monitor.MemInfo\022&\n\010net_info\030\010 \003(\0132\024.rpc_"
  "monitor.NetInfo2\231\001\n\013GrpcManager\022D\n\016SetMo"
  "nitorInfo\022\030.rpc_monitor.MonitorInfo\032\026.go"
  "ogle.protobuf.Empty\"\000\022D\n\016GetMonitorInfo\022"
  "\026.google.protobuf.Empty\032\030.rpc_monitor.Mo"
  "nitorInfo\"\000b\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_monitor_5finfo_2eproto = {
  false, false, descriptor_table_protodef_monitor_5finfo_2eproto, "monitor_info.proto", 539,
...
class MonitorInfo::_Internal {
 public:
  static const ::rpc_monitor::CpuLoad& cpu_load(const MonitorInfo* msg);
  static const ::rpc_monitor::MemInfo& mem_info(const MonitorInfo* msg);
};

const ::rpc_monitor::CpuLoad&
MonitorInfo::_Internal::cpu_load(const MonitorInfo* msg) {
  return *msg->cpu_load_;
}
const ::rpc_monitor::MemInfo&
...
MonitorInfo::MonitorInfo(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:rpc_monitor.MonitorInfo)
}
MonitorInfo::MonitorInfo(const MonitorInfo& from)
  ...
  if (from._internal_has_cpu_load()) {
    cpu_load_ = new ::rpc_monitor::CpuLoad(*from.cpu_load_);
  } else {
    cpu_load_ = nullptr;
  }
  if (from._internal_has_mem_info()) {
    mem_info_ = new ::rpc_monitor::MemInfo(*from.mem_info_);
  } else {
    mem_info_ = nullptr;
  }
  // @@protoc_insertion_point(copy_constructor:rpc_monitor.MonitorInfo)
}
...
MonitorInfo::~MonitorInfo() {
  // @@protoc_insertion_point(destructor:rpc_monitor.MonitorInfo)
  SharedDtor();
...
// @@protoc_insertion_point(message_clear_start:rpc_monitor.MonitorInfo)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "rpc_monitor.MonitorInfo.name"));
          CHK_(ptr);
...
::PROTOBUF_NAMESPACE_ID::uint8* MonitorInfo::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:rpc_monitor.MonitorInfo)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:rpc_monitor.MonitorInfo)
  return target;
}

size_t MonitorInfo::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:rpc_monitor.MonitorInfo)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:rpc_monitor.MonitorInfo)
  GOOGLE_DCHECK_NE(&from, this);
  const MonitorInfo* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<MonitorInfo>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:rpc_monitor.MonitorInfo)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:rpc_monitor.MonitorInfo)
    MergeFrom(*source);
  }
}

void MonitorInfo::MergeFrom(const MonitorInfo& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:rpc_monitor.MonitorInfo)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (from.has_cpu_load()) {
    _internal_mutable_cpu_load()->::rpc_monitor::CpuLoad::MergeFrom(from._internal_cpu_load());
  }
  if (from.has_mem_info()) {
    _internal_mutable_mem_info()->::rpc_monitor::MemInfo::MergeFrom(from._internal_mem_info());
  }
}

void MonitorInfo::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:rpc_monitor.MonitorInfo)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:rpc_monitor.MonitorInfo)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::rpc_monitor::MonitorInfo* Arena::CreateMaybeMessage< ::rpc_monitor::MonitorInfo >(Arena* arena) {
  return Arena::CreateMessageInternal< ::rpc_monitor::MonitorInfo >(arena);
}
