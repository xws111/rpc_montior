...
static void InitDefaultsscc_info_NetInfo_net_5finfo_2eproto() {
  ...
  {
    void* ptr = &::rpc_monitor::_NetInfo_default_instance_;
    new (ptr) ::rpc_monitor::NetInfo();
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_net_5finfo_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::NetInfo, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::NetInfo, name_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::NetInfo, send_rate_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::NetInfo, rcv_rate_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::NetInfo, send_packets_rate_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::NetInfo, rcv_packets_rate_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::rpc_monitor::NetInfo)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::rpc_monitor::_NetInfo_default_instance_),
};

const char descriptor_table_protodef_net_5finfo_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\016net_info.proto\022\013rpc_monitor\"q\n\007NetInfo"
  "\022\014\n\004name\030\001 \001(\t\022\021\n\tsend_rate\030\002 \001(\002\022\020\n\010rcv"
  "_rate\030\003 \001(\002\022\031\n\021send_packets_rate\030\004 \001(\002\022\030"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_net_5finfo_2eproto = {
  false, false, descriptor_table_protodef_net_5finfo_2eproto, "net_info.proto", 152,
...
NetInfo::NetInfo(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:rpc_monitor.NetInfo)
}
NetInfo::NetInfo(const NetInfo& from)
  ...
  // @@protoc_insertion_point(copy_constructor:rpc_monitor.NetInfo)
}
...
NetInfo::~NetInfo() {
  // @@protoc_insertion_point(destructor:rpc_monitor.NetInfo)
  SharedDtor();
...
void NetInfo::Clear() {
// @@protoc_insertion_point(message_clear_start:rpc_monitor.NetInfo)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "rpc_monitor.NetInfo.name"));
          CHK_(ptr);
...
::PROTOBUF_NAMESPACE_ID::uint8* NetInfo::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:rpc_monitor.NetInfo)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:rpc_monitor.NetInfo)
  return target;
}

size_t NetInfo::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:rpc_monitor.NetInfo)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:rpc_monitor.NetInfo)
  GOOGLE_DCHECK_NE(&from, this);
  const NetInfo* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<NetInfo>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:rpc_monitor.NetInfo)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:rpc_monitor.NetInfo)
    MergeFrom(*source);
  }
}

void NetInfo::MergeFrom(const NetInfo& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:rpc_monitor.NetInfo)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:rpc_monitor.NetInfo)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:rpc_monitor.NetInfo)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::rpc_monitor::NetInfo* Arena::CreateMaybeMessage< ::rpc_monitor::NetInfo >(Arena* arena) {
  return Arena::CreateMessageInternal< ::rpc_monitor::NetInfo >(arena);
}
