...
static void InitDefaultsscc_info_SoftIrq_cpu_5fsoftirq_2eproto() {
  ...
  {
    void* ptr = &::rpc_monitor::_SoftIrq_default_instance_;
    new (ptr) ::rpc_monitor::SoftIrq();
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_cpu_5fsoftirq_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::SoftIrq, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::SoftIrq, cpu_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::SoftIrq, hi_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::SoftIrq, timer_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::SoftIrq, net_tx_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::SoftIrq, net_rx_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::SoftIrq, block_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::SoftIrq, irq_poll_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::SoftIrq, tasklet_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::SoftIrq, sched_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::SoftIrq, hrtimer_),
  PROTOBUF_FIELD_OFFSET(::rpc_monitor::SoftIrq, rcu_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::rpc_monitor::SoftIrq)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::rpc_monitor::_SoftIrq_default_instance_),
};

const char descriptor_table_protodef_cpu_5fsoftirq_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\021cpu_softirq.proto\022\013rpc_monitor\"\260\001\n\007Sof"
  "tIrq\022\013\n\003cpu\030\001 \001(\t\022\n\n\002hi\030\002 \001(\002\022\r\n\005timer\030\003"
  " \001(\002\022\016\n\006net_tx\030\004 \001(\002\022\016\n\006net_rx\030\005 \001(\002\022\r\n\005"
  "block\030\006 \001(\002\022\020\n\010irq_poll\030\007 \001(\002\022\017\n\007tasklet"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_cpu_5fsoftirq_2eproto = {
  false, false, descriptor_table_protodef_cpu_5fsoftirq_2eproto, "cpu_softirq.proto", 219,
...
SoftIrq::SoftIrq(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:rpc_monitor.SoftIrq)
}
SoftIrq::SoftIrq(const SoftIrq& from)
  ...
  // @@protoc_insertion_point(copy_constructor:rpc_monitor.SoftIrq)
}
...
SoftIrq::~SoftIrq() {
  // @@protoc_insertion_point(destructor:rpc_monitor.SoftIrq)
  SharedDtor();
...
void SoftIrq::Clear() {
// @@protoc_insertion_point(message_clear_start:rpc_monitor.SoftIrq)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "rpc_monitor.SoftIrq.cpu"));
          CHK_(ptr);
...
::PROTOBUF_NAMESPACE_ID::uint8* SoftIrq::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:rpc_monitor.SoftIrq)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:rpc_monitor.SoftIrq)
  return target;
}

size_t SoftIrq::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:rpc_monitor.SoftIrq)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:rpc_monitor.SoftIrq)
  GOOGLE_DCHECK_NE(&from, this);
  const SoftIrq* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<SoftIrq>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:rpc_monitor.SoftIrq)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:rpc_monitor.SoftIrq)
    MergeFrom(*source);
  }
}

void SoftIrq::MergeFrom(const SoftIrq& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:rpc_monitor.SoftIrq)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:rpc_monitor.SoftIrq)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:rpc_monitor.SoftIrq)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::rpc_monitor::SoftIrq* Arena::CreateMaybeMessage< ::rpc_monitor::SoftIrq >(Arena* arena) {
  return Arena::CreateMessageInternal< ::rpc_monitor::SoftIrq >(arena);
}
