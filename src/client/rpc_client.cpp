...
RpcClient::RpcClient() {
  ...
  stub_ptr_ = rpc_monitor::GrpcManager::NewStub(channel);
}

RpcClient::~RpcClient() {}

void RpcClient::SetMonitorInfo(const rpc_monitor::MonitorInfo& monitor_info) {
...
void RpcClient::GetMonitorInfo(rpc_monitor::MonitorInfo* monito_info) {
  ::grpc::ClientContext context;
